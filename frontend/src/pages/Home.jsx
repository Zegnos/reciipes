        ...
        <div className="container">
          <div className="home-header-content">
            ...
            <p className="home-description">
              Les recettes finissent souvent éparpillées entre la galerie, les notes ou des papiers.
              Reciipes les regroupe dans un seul endroit : un outil simple et pratique, accessible sur tous les appareils,
              pour garder ses recettes clairement organisées.
          ...
          <div className="logo">
            <img src="/Logo_reciipes_nobg.png" alt="Reciipes" />
          </div>
        </div>
      </header>
